...
8. Implement cross-SPN communication via the Mailbox contract with proper nonce tracking and replay protection. Verify mailbox addresses on PharosScan: `https://pharosscan.xyz/pharos/address/{mailbox_contract}`.
